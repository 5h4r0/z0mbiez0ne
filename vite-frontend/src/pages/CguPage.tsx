  ...
  return (
    <div className="static-page">
      <div className="static-page__inner">
        ...
        <div className="static-page__body" style={{ marginBottom: '40px' }}>
        ...
        <div className="static-page__body" style={{ marginTop: '32px' }}>
          <p style={{ fontSize: '0.8rem' }}>
            Dernière mise à jour : avant la première morsure officiellement enregistrée.
          </p>
          <p style={{ fontSize: '0.8rem' }}>
            Pour toute question :{' '}
            <a href="mailto:cgu@zombiezone.fr" style={{ color: 'var(--color-red)', textDecoration: 'none' }}>
              cgu@zombiezone.fr
            </a>
          </p>
        </div>
