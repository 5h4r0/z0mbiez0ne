    ...
    <div className="static-page">
      <div className="static-page__inner">
        ...
        <div className="static-page__body">
          <p>
            <strong style={{ color: 'var(--color-text)' }}>ZombieZone SAS</strong>
          </p>
          ...
          <p>
            Contact :{' '}
            <a href="mailto:legal@zombiezone.fr" style={{ color: 'var(--color-red)', textDecoration: 'none' }}>
              legal@zombiezone.fr
            </a>
          </p>
        </div>
        ...
        <div className="static-page__body">
          <p>
            <strong style={{ color: 'var(--color-text)' }}>Kadath Hosting</strong>
          </p>
