    ...
    <div className="static-page">
      <div className="static-page__inner">
        ...
        <div className="static-page__body">
          ...
          <ul>
            <li>
              <strong className="text-(--color-text)">Droit d'accès</strong> : obtenir une copie de vos données
            </li>
            <li>
              <strong className="text-(--color-text)">Droit de rectification</strong> : corriger des données inexactes
            </li>
            <li>
              <strong className="text-(--color-text)">Droit à l'effacement</strong> : demander la suppression de vos
              données
            </li>
            <li>
              <strong className="text-(--color-text)">Droit à la portabilité</strong> : recevoir vos données dans un
              format structuré
            </li>
            <li>
              <strong className="text-(--color-text)">Droit d'opposition</strong> : vous opposer au traitement pour
              raisons légitimes
            </li>
            <li>
              <strong className="text-(--color-text)">Droit de limitation</strong> : limiter le traitement dans certains
              cas
            </li>
          </ul>
        </div>
        ...
        <div className="static-page__body">
          <p>
            <strong className="text-(--color-text)">Délégué à la Protection des Données :</strong> Igor Necromov
          </p>
          <p>
            E-mail :{' '}
          ...
          <p>
            ...
            <a
              ...
              className="text-(--color-red) no-underline"
            >
              www.cnil.fr
            </a>
          </p>
        ...
        <div className="static-page__body mt-10 border-t border-(--color-border) pt-5">
          <p className="text-[0.8rem]">Dernière mise à jour : cycle lunaire précédant l'ouverture du parc.</p>
        </div>
      </div>
    </div>
  );
